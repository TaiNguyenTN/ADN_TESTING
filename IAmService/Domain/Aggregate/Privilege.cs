...
namespace Domain.Aggregate
{
    ...
    {
        #region Attributes
        private readonly List<UserPrivilege> _userPrivileges = new();
        private readonly List<RolePrivilege> _rolePrivileges = new();
        #endregion
        ...
        {
            get { return _userPrivileges.AsReadOnly(); }
        }

        public IReadOnlyCollection<RolePrivilege> RolePrivileges
        {
            get { return _rolePrivileges.AsReadOnly(); }
        }
        #endregion
